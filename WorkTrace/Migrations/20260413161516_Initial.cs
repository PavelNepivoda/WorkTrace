...
namespace WorkTrace.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ContractTypes",
                columns: new[] { "Id", "Description", "HourlyWage", "Name" },
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), null, 200m, "HPP" },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), null, 150m, "DPP" },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), null, 120m, "DPČ" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "Běžný zaměstnanec", "Zaměstnanec" },
